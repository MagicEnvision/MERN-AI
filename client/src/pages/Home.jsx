  ...
  return (
    <section className="max-w-7xl mx-auto" >
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">Browse through a collection of imaginative and visually
      ...
      <div className='mt-10'>
        {
          ...
          <>
            {searchText && (
              ...
              mb-3'>Showing results for <span className='text-[#222328]'>{searchText}</span></h2>
            )}
