      ...
      <form action="" className='mt-16 max-w-3xl' onSubmit={handleSubmit()}>
        ...
        <div className='relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500
          focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center'>
            ...
            {generatingImg && (
              <div className='absolute inset-0 flex z-0 justify-center items-center 
          ...
          <div className="mt-10">
            <p className='mt-2 text-[#666e75] text-[14px]'>Once you have created your image 
            if you want you can share it with the community</p>
            <button 
            type='submit'
